...
class MempoolPackageLimitsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Large padding uses nonstandard datacarrier outputs under Knots policy.
        self.restart_node(0, extra_args=["-acceptnonstdtxn=1", "-acceptnonstddatacarrier=1", "-datacarrierfullcount=0"])
