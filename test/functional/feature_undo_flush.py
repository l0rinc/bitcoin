...
"""Test that dirty undo files are flushed before block index metadata is persisted."""
...
class UndoFlushTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # -fastprune uses smaller blockfiles. Keep file 0 below the limit until
        ...
        self.log.info("Submit a side chain block")
        b2 = create_block(int(fork_base_hash, 16), create_coinbase(2), ntime=fork_base_time + 1)
        b2.solve()
