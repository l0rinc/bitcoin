...
class CoinsDBReadErrorTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.restart_node(0)  # Flush caches and release files
        ...
        node.wait_until_stopped(expected_stderr="Error: Cannot read database, shutting down.", expected_ret_code=-6,  timeout=10)
