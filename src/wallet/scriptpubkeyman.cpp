...
{
    return ::SignTransaction(tx, this, coins, {.sighash_type = sighash}, input_errors, inputs_amount_sum);
}
...
std::optional<PSBTError> LegacyScriptPubKeyMan::FillPSBT(PartiallySignedTransaction& psbtx, const PrecomputedTransactionData& txdata, const common::PSBTFillOptions& options, int* n_signed) const
{
    if (n_signed) {
        *n_signed = 0;
    }
    for (unsigned int i = 0; i < psbtx.inputs.size(); ++i) {
        ...
        PSBTError res = SignPSBTInput(HidingSigningProvider(this, /*hide_secret=*/!options.sign, /*hide_origin=*/!options.bip32_derivs), psbtx, i, &txdata, options, /*out_sigdata=*/nullptr);
    ...
    for (unsigned int i = 0; i < psbtx.outputs.size(); ++i) {
        UpdatePSBTOutput(HidingSigningProvider(this, /*hide_secret=*/true, /*hide_origin=*/!options.bip32_derivs), psbtx, i);
    }
