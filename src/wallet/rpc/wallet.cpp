    ...
    return RPCHelpMan{"getwalletinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::BOOL, "private_keys_enabled", "false if private keys are disabled for this wallet"},
...
static RPCHelpMan createwallet()
{
    return RPCHelpMan{
        ...
        "Creates and loads a new wallet.\n",
        {
            ...
            {"disable_private_keys", RPCArg::Type::BOOL, RPCArg::Default{false}, "Disable the possibility of private keys. This is intended for watch-only or external-signer wallets."},
