...
constexpr size_t ByteUnitsToBytes(uint64_t units, std::string exception_msg)
{
...
constexpr size_t operator""_MiB(uint64_t mebibytes)
{
...
constexpr size_t operator""_GiB(uint64_t gibibytes)
{
