...
bool AreInputsStandard(const CTransaction& tx, const CCoinsViewCache& mapInputs)
{
    ...
    for (unsigned int i = 0; i < tx.vin.size(); i++) {
        ...
        case 0: continue;
        case 4: if (prev.scriptPubKey.IsPayToAnchor()) continue;
        case 22: if (prev.scriptPubKey.IsPayToWitnessPubKeyHash()) continue;
        case 23: if (prev.scriptPubKey.IsPayToScriptHash()) continue;
        case 25: if (prev.scriptPubKey.IsPayToPubKeyHash()) continue;
        case 34: if (prev.scriptPubKey.IsPayToTaproot() || prev.scriptPubKey.IsPayToWitnessScriptHash()) continue;
        case 35: if (prev.scriptPubKey.IsCompressedPayToPubKey()) continue;
        case 67: if (prev.scriptPubKey.IsUncompressedPayToPubKey()) continue;
        }
