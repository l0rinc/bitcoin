...
//      fillbatch     -- write N/1000 batches of 1000 sequential keys in async mode
...
//      readrandomsmall -- read N/1000 times in random order
//      readmissing   -- read N missing keys in random order
//      readhot       -- read N times in random order from 1% section of DB
//      seekrandom    -- N random seeks
//      readwhilewriting -- concurrent random reads while one extra thread writes
//      open          -- cost of opening a DB
//      crc32c        -- repeated crc32c of 4K of data
//      snappycomp    -- repeated Snappy compression
//      snappyuncomp  -- repeated Snappy decompression
//   Meta operations:
