...
namespace node {
// Complete initialization of the chainstate after the initial call has been made
    ...
    const ChainstateLoadOptions& options) EXCLUSIVE_LOCKS_REQUIRED(::cs_main)
{
    ...
    // Populate setBlockIndexCandidates after LoadChainTip() has finished
    // modifying nSequenceId. Because nSequenceId is used in the
    ...
    // Now that the chainstate is loaded and we're able to flush to
    // disk, rebalance the coins caches to desired levels based
    // on the condition of the chainstate.
