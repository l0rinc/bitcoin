...
bool BlockManager::FlushChainstateBlockFile(int tip_height)
{
    ...
    // Blocks can be written out of order while undo data is written in validation order.
    // Flush every dirty undo file before persisting block index metadata that may
    // advertise BLOCK_HAVE_UNDO for those files.
