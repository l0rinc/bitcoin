 ...
 * section between the parentheses, and true is returned. Otherwise sp is unmodified and false
 * is returned.
 */
 ...
 * comma or closing parenthesis, skipping ones that are surrounded by parentheses. So for example,
