                                    ...
                                    unsigned int nIn, unsigned int flags, bitcoinconsensus_error* err)
{
    ...
    try {
        ...
        const script_verify_flags script_flags{script_verify_flags::from_int(flags)};
        return VerifyScript(tx.vin[nIn].scriptSig, CScript(scriptPubKey, scriptPubKey + scriptPubKeyLen), &tx.vin[nIn].scriptWitness, script_flags, TransactionSignatureChecker(&tx, nIn, amount, txdata, MissingDataBehavior::FAIL), nullptr);
