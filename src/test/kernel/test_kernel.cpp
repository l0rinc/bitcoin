...
BOOST_AUTO_TEST_CASE(btck_precomputed_txdata) {
    auto tx_data{hex_string_to_byte_vec("")};
    auto tx{Transaction{tx_data}};
    auto spent_script{ScriptPubkey{hex_string_to_byte_vec("76a9144bfbaf6afb76cc5771bc6404810d1cc041a6933988ac")}};
    auto spent_output{TransactionOutput{spent_script, 1}};
    auto tx_data_2{hex_string_to_byte_vec("")};
    auto tx2{Transaction{tx_data_2}};
    auto precomputed_txdata{PrecomputedTransactionData{
        /*tx_to=*/tx,
        /*spent_outputs=*/std::span<const TransactionOutput>{&spent_output, 1},
    }};
...
BOOST_AUTO_TEST_CASE(btck_block_tree_entry_tests)
{
    ...
    BOOST_CHECK_EQUAL(btck_block_tree_entry_get_ancestor(entry_2.get(), /*height=*/-1), nullptr);
    BOOST_CHECK_EQUAL(btck_block_tree_entry_get_ancestor(entry_2.get(), /*height=*/3), nullptr);
    BOOST_CHECK_THROW(entry_2.GetAncestor(3), std::runtime_error);
}
