...
BOOST_AUTO_TEST_CASE(parse_script)
{
    ...
    BOOST_CHECK_EXCEPTION(ParseScript("11111111111111111111"), ScriptParseError, HasReason("script parse error: decimal numeric value only allowed in the range -0xFFFFFFFF...0xFFFFFFFF"));
    BOOST_CHECK_EXCEPTION(ParseScript("11111111111"), ScriptParseError, HasReason("script parse error: decimal numeric value only allowed in the range -0xFFFFFFFF...0xFFFFFFFF"));
    BOOST_CHECK_EXCEPTION(ParseScript("OP_CHECKSIGADD"), ScriptParseError, HasReason("script parse error: unknown opcode"));
}
