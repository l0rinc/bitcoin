...
BOOST_AUTO_TEST_CASE(siphash)
{
    ...
    // The jumboblock variant is intentionally non-standard and only used for already-hashed local index keys.
    BOOST_CHECK_EQUAL(PresaltedSipHasher13Jumbo(0x0706050403020100ULL, 0x0F0E0D0C0B0A0908ULL)(uint256{"1f1e1d1c1b1a191817161514131211100f0e0d0c0b0a09080706050403020100"}), 0x0741b3ab33c5c0d2ull);
