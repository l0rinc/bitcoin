...
{
    const size_t file_size{m_rng.randrange<size_t>(2 << 20)};
    const size_t max_read_length{m_rng.randrange<size_t>(1 << 10)};
...
{
    const size_t file_size{m_rng.randrange<size_t>(2 << 20)};
    const size_t max_write_length{m_rng.randrange<size_t>(1 << 10)};
    const FlatFilePos pos{0, 0};
