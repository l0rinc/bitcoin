...
BOOST_AUTO_TEST_CASE(chacha20_split_crypt_regression)
{
    ...
    TestChaCha20SplitCrypt(ChaCha20Aligned::BLOCKLEN * 4, {0x21222324, 0x25262728292a2b2c}, std::numeric_limits<uint32_t>::max() - 3);
