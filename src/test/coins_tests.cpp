...
class CCoinsViewTest : public CCoinsViewCache
{
...
public:
    explicit CCoinsViewTest(FastRandomContext& rng) : CCoinsViewCache(nullptr), m_rng{rng} {}
...
public:
    ...
    CCoinsViewCacheTest base{nullptr};
...
{
    CCoinsViewCacheTest cache{nullptr};
