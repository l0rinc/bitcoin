...
BOOST_AUTO_TEST_CASE(test_query_parameters)
{
    ...
    CHECK(!GetQueryParameterFromUri(uri.c_str(), "p1").has_value());
    ...
    uri = "/rest/endpoint/someresource.json&p1=v1&p2=v2%";
    CHECK_EXCEPTION(GetQueryParameterFromUri(uri.c_str(), "p1"), std::runtime_error, HasReason("URI parsing failed, it likely contained RFC 3986 invalid characters"));
}
