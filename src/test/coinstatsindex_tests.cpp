...
BOOST_FIXTURE_TEST_CASE(coinstatsindex_unclean_shutdown, TestChain100Setup)
{
    ...
    const CChainParams& params = Params();
    {
        ...
        CBlockIndex* new_block_index = nullptr;
        {
            ...
            BOOST_CHECK(CheckBlock(block, block.GetHash(), state, params.GetConsensus()));
            BOOST_CHECK(m_node.chainman->AcceptBlock(new_block, new_block->GetHash(), state, &new_block_index, true, nullptr, nullptr, true));
