...
CNode* ConnmanTestMsg::ConnectNodePublic(PeerManager& peerman, const std::string& dest, ConnectionType conn_type)
{
    CNode* node = ConnectNode(CAddress{}, &dest, /*fCountFailure=*/false, conn_type, /*use_v2transport=*/true, /*proxy_override=*/std::nullopt);
