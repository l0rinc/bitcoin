...
FUZZ_TARGET(coins_view, .init = initialize_coins_view)
{
    ...
    CCoinsViewCache coins_view_cache{&CCoinsViewEmpty::Get(), /*deterministic=*/true};
    TestCoinsView(fuzzed_data_provider, coins_view_cache, &CCoinsViewEmpty::Get());
}
...
{
    FuzzedDataProvider fuzzed_data_provider{buffer.data(), buffer.size()};
    MutationGuardCoinsViewCache backend_cache{&CCoinsViewEmpty::Get(), /*deterministic=*/true};
