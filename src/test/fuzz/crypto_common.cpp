...
FUZZ_TARGET(crypto_common)
{
    ...
    CHECK(std::memcmp(random_bytes_2.data(), readle16_arr.data(), 2) == 0);
    ...
    CHECK(std::memcmp(random_bytes_4.data(), readle32_arr.data(), 4) == 0);
    ...
    CHECK(std::memcmp(random_bytes_8.data(), readle64_arr.data(), 8) == 0);
    ...
    CHECK(std::memcmp(random_bytes_4.data(), readbe32_arr.data(), 4) == 0);
    ...
    CHECK(std::memcmp(random_bytes_8.data(), readbe64_arr.data(), 8) == 0);
}
