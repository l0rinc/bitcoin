...
enum BlockStatus : uint32_t {
    ...
    BLOCK_STATUS_RESERVED    =   256, //!< Unused reserved flag.
};
...
public:
    ...
    /**
     * Check whether this block and all previous blocks back to the genesis block have reached VALID_TRANSACTIONS and had
