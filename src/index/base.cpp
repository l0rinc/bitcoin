...
BaseIndex::DB::DB(const fs::path& path, size_t n_cache_size, bool f_memory, bool f_wipe, bool f_obfuscate, bool f_bloom, std::optional<size_t> block_cache_bytes, std::optional<size_t> write_buffer_bytes) :
    CDBWrapper{DBParams{
        .path = path,
