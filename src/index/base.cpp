...
BaseIndex::BaseIndex(std::unique_ptr<interfaces::Chain> chain, std::string name, const std::string& thread_name)
    : m_chain{std::move(chain)}, m_name{std::move(name)}, m_thread_name{thread_name.empty() ? m_name : thread_name} {}
