...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-blockfetchpar=<n>", strprintf("Set the number of threads and queued blocks used to read blocks ahead during chain activation (0 disables, up to %d, default: %d). Negative values are rejected.", MAX_BLOCKFETCH_THREADS, DEFAULT_BLOCKFETCH_THREADS), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
#if HAVE_SYSTEM
