...
bool AppInitParameterInteraction(const ArgsManager& args)
{
    ...
    // Also report errors from parsing before daemonization
    {
        ...
        auto chainman_result{ApplyArgsManOptions(args, chainman_opts_dummy, 0)};
        if (!chainman_result) {
    ...
    const ArgsManager& args)
{
    ...
    Assert(ApplyArgsManOptions(args, chainman_opts, cache_sizes.coins)); // no error can happen, already checked in AppInitParameterInteraction
