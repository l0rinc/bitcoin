...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-blockdeserthreads=<n>", strprintf("Number of worker threads that deserialize and pre-check received blocks, 0 to do it on the message handler thread (default: %d)", DEFAULT_BLOCKDESER_THREADS), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
