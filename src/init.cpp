...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-headerssynccache=<n>", "Maximum headers sync cache size <n> MiB (default: ~10%% of free RAM). Make sure you have enough RAM.", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
