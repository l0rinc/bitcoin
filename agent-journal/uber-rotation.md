...
1. Random draw (user-mandated policy since 2026-07-28): recorded seed over
   ...
   raw=11412206341905458499 -> idx 1 (of 30) -> #1.
...
5/52, 62, 56, 96, 20, 0(c1), 4(c1,c2), 8, 15, 6(c1), 27, 7(c1), 3, 9(c1), 11, 12, 13, 14, 18(c2,c3,QUEUE-COMPLETE), 19(EXHAUSTED), 28(c2), 16(c2), 61(c3), 30(c3), 31(c3,c4), 29(c2), 17(c2,c3), 21(c1), 22(c1,c2), 1(c1), 36(c1), 37(c1), 39(c1), 43(c1), 45(c1), 47(c1), 51(c1), 59(c1), 65(c1), 66(c1), 68(c1), 71(c1), 73(c1), 75(c1), 90(c1), 91(c1), 94(c1), 95(c1) DONE.
