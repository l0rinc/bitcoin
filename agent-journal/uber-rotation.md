...
1. 6 — serialization untrusted-input — NEXT (severity-first)
...
5/52, 62, 56, 96, 20, 0(c1), 4(c1,c2), 8, 15 DONE.
...
full cross-backend differential in ~35s on this host. NEXT: #6 on branch
audit/serialization-untrusted-input.
