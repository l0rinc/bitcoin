...
* Optimizations (achieving a >20% cumulative IBD speedup)
  ...
  * [`coins: use jumboblock SipHash-1-3 for hashing CCoinsMap keys`](https://github.com/bitcoin/bitcoin/pull/35215)
...
<details>
<summary>279 Merged Commits</summary>

> git --no-pager log upstream/master --author="lorinc" --no-merges --pretty=format:"%h %ad %s" --date=format:"%Y-%m-%d" --abbrev=10

* [2026-06-12 test: remove redundant test suite uniqueness lint](https://github.com/bitcoin/bitcoin/commit/946feb3f1f)
* [2026-05-20 util: zero-pad thread number suffixes](https://github.com/bitcoin/bitcoin/commit/d69c46292d)
* [2026-05-20 util: shorten `ThreadPool` worker names](https://github.com/bitcoin/bitcoin/commit/41e531c4ab)
* [2026-05-20 index: shorten indexer thread names](https://github.com/bitcoin/bitcoin/commit/d3e40af259)
* [2026-05-06 wallet: use outpoint when estimating input size](https://github.com/bitcoin/bitcoin/commit/cd8d3bd937)
* [2026-05-06 wallet: check BDB last page LSN](https://github.com/bitcoin/bitcoin/commit/e2b0984f99)
* [2026-05-06 test: fix P2SH output in coins cache fuzz](https://github.com/bitcoin/bitcoin/commit/ac58e6c53c)
* [2026-05-03 ci: unconfine seccomp for i686 no IPC](https://github.com/bitcoin/bitcoin/commit/11c9ef92a8)
* [2026-04-28 doc: clarify IWYU workflow](https://github.com/bitcoin/bitcoin/commit/d084bc88be)
* [2026-04-28 ci: update IWYU patch reference](https://github.com/bitcoin/bitcoin/commit/7c7cec4567)
* [2026-04-24 test: cover repeated dbwrapper stream use](https://github.com/bitcoin/bitcoin/commit/cb1ab0a716)
* [2026-04-24 streams: add `ScopedDataStreamUsage`](https://github.com/bitcoin/bitcoin/commit/31ce729b28)
* [2026-04-24 dbwrapper: reuse iterator scratch stream](https://github.com/bitcoin/bitcoin/commit/032223f403)
* [2026-04-24 dbwrapper: guard `CDBBatch` scratch streams](https://github.com/bitcoin/bitcoin/commit/7403c0f907)
* [2026-04-23 bench: make `setup()` use single-iteration epochs](https://github.com/bitcoin/bitcoin/commit/e6430b2773)
* [2026-04-23 bench: fix ephemeral spend inputs](https://github.com/bitcoin/bitcoin/commit/ba0078e3bf)
* [2026-04-23 bench: drop duplicate balance benchmark](https://github.com/bitcoin/bitcoin/commit/b8b7f896e8)
* [2026-04-21 test: cover failed `CDBIterator::GetKey()` deserialization](https://github.com/bitcoin/bitcoin/commit/f0e498af5c)
* [2026-04-21 dbwrapper: use `SpanReader` for iterator keys](https://github.com/bitcoin/bitcoin/commit/5de2f97a05)
* [2026-04-07 test: convert truthy asserts in `wallet_miniscript` and `rpc_psbt`](https://github.com/bitcoin/bitcoin/commit/06a4176c42)
* [2026-04-07 refactor: use `SpanReader` in `TestBlockAndIndex`](https://github.com/bitcoin/bitcoin/commit/b8eb6c2081)
* [2026-04-07 refactor: use `SpanReader` in `PrevectorDeserialize`](https://github.com/bitcoin/bitcoin/commit/2529f25555)
* [2026-04-07 refactor: replace `DataStream` with `SpanReader` in block deserialization tests](https://github.com/bitcoin/bitcoin/commit/13c8df4d5a)
* [2026-03-08 test: use `in` for two-value equality asserts](https://github.com/bitcoin/bitcoin/commit/76a5570b36)
* [2026-03-08 test: split equality asserts joined by `and`](https://github.com/bitcoin/bitcoin/commit/4f4516e3f6)
* [2026-03-08 test: prep manual equality assert conversions](https://github.com/bitcoin/bitcoin/commit/dcd90fbe54)
* [2026-03-08 test: convert simple equality asserts in excluded files](https://github.com/bitcoin/bitcoin/commit/d9a3cf20a4)
* [2026-03-08 test: convert equality asserts with comments or special chars](https://github.com/bitcoin/bitcoin/commit/23c06d4e6d)
* [2026-03-08 test: add missing `assert_equal` imports](https://github.com/bitcoin/bitcoin/commit/301b1d7b1f)
* [2026-03-08 scripted-diff: replace remaining Python test equality asserts](https://github.com/bitcoin/bitcoin/commit/3fd68a95e6)
* [2026-03-02 doc: explain swapping in `reduce-memory.md`](https://github.com/bitcoin/bitcoin/commit/a61907e5d9)
...
* [2026-02-20 refactor: rename `hashBlock` to `m_block_hash` to avoid shadowing](https://github.com/bitcoin/bitcoin/commit/06172ef0d5)
* [2026-02-20 refactor: normalize CCoinsView whitespace and signatures](https://github.com/bitcoin/bitcoin/commit/a9f92e3497)
* [2026-02-20 refactor: inline `CCoinsViewBacked` implementation](https://github.com/bitcoin/bitcoin/commit/8783cc8056)
* [2026-02-20 coins: make `CCoinsView` methods pure virtual](https://github.com/bitcoin/bitcoin/commit/86296f276d)
...
* [2026-02-16 bench: use deterministic `HexStr` payload](https://github.com/bitcoin/bitcoin/commit/353c660be5)
* [2026-02-15 scripted-diff: normalize `CCoinsView` naming](https://github.com/bitcoin/bitcoin/commit/38a99f3344)
* [2026-02-15 fuzz: keep backend assertions aligned to active backend](https://github.com/bitcoin/bitcoin/commit/90c635c01c)
* [2026-02-15 coins: add explicit `CoinsViewEmpty` noop backend](https://github.com/bitcoin/bitcoin/commit/b637566c8d)
...
* [2026-01-28 util: add _GiB for Gibibyte conversions](https://github.com/bitcoin/bitcoin/commit/b3edd30aa2)
* [2026-01-28 refactor: use _MiB consistently for Mebibyte conversions](https://github.com/bitcoin/bitcoin/commit/af0ee28eb6)
* [2026-01-28 refactor: add overflow-safe `CeilDiv` helper](https://github.com/bitcoin/bitcoin/commit/02d047fd5b)
...
* [2026-01-16 test: add pre-`LogPeer` net log assertion](https://github.com/bitcoin/bitcoin/commit/e55ea534f7)
* [2026-01-16 net: format peer+addr logs with `LogPeer`](https://github.com/bitcoin/bitcoin/commit/22335474d7)
* [2026-01-16 log: show placeholders for missing peer fields](https://github.com/bitcoin/bitcoin/commit/9cf82bed32)
* [2026-01-16 log: fix minor formatting in debug logs](https://github.com/bitcoin/bitcoin/commit/736b17c0f0)
...
* [2026-01-11 test: enable `rpc_bind` on macOS and BSD](https://github.com/bitcoin/bitcoin/commit/1950da94fc)
* [2026-01-11 test: enable `feature_bind_extra` on macOS and BSD](https://github.com/bitcoin/bitcoin/commit/7236a05503)
...
* [2026-01-03 refactor: improve benchmark setup and execution for various tests](https://github.com/bitcoin/bitcoin/commit/8825051e08)
* [2026-01-03 bench: add fluent API for untimed setup steps in `nanobench`](https://github.com/bitcoin/bitcoin/commit/83b8528ddb)
* [2025-12-30 refactor: use `DataStream::clear` in `::read` and `::ignore`](https://github.com/bitcoin/bitcoin/commit/61d678a6e3)
...
* [2024-12-09 rpc: fix getblockstats UTXO overhead accounting](https://github.com/bitcoin/bitcoin/commit/5f36e0ff1e)
* [2024-12-09 coins: pack `Coin` height/coinbase consistently](https://github.com/bitcoin/bitcoin/commit/76190489e6)
* [2024-12-09 coins: make `Coin::fCoinBase` a bool](https://github.com/bitcoin/bitcoin/commit/1f309d1aa2)
...
<details>
<summary>77 Merged Co-authored Commits</summary>
...
* [2026-06-03 lint: Grep for `AUTO` test suites in file names](https://github.com/bitcoin/bitcoin/commit/f6bdbcf79d)
* [2026-05-19 test: Add test for BuildSkip() and skip heights](https://github.com/bitcoin/bitcoin/commit/131fa570b9)
* [2026-05-11 bench: add benchmark for GetMappedAS()](https://github.com/bitcoin/bitcoin/commit/096bb0b5c0)
* [2026-04-13 bench: improve `VerifyNestedIfScript` benchmark precision (make stack clearing untimed)](https://github.com/bitcoin/bitcoin/commit/fbffe8a64a)
* [2026-04-09 bench: add script verification benchmark for P2TR script-path spends](https://github.com/bitcoin/bitcoin/commit/616ee6fe74)
* [2026-04-08 net_processing: don't modify addrman for private broadcast connections](https://github.com/bitcoin/bitcoin/commit/1ed1a12402)
* [2026-03-21 test: add fuzz harness for CDBWrapper](https://github.com/bitcoin/bitcoin/commit/b63ef20d54)
* [2026-03-13 bench: Replace Coin Selection bench](https://github.com/bitcoin/bitcoin/commit/0429c503fb)
* [2026-03-13 bench: Remove unnecessary wallet parameter](https://github.com/bitcoin/bitcoin/commit/ec1eefda77)
* [2026-03-13 bench: Fix type mismatch](https://github.com/bitcoin/bitcoin/commit/e6c4ffb956)
* [2026-02-26 refactor: Enable -Wswitch in exhaustive switch](https://github.com/bitcoin/bitcoin/commit/fa2670bd4b)
* [2026-02-12 threadpool: add ranged Submit overload](https://github.com/bitcoin/bitcoin/commit/79571b9181)
...
* [2026-02-05 test(miniscript): Check for depth rather than script size](https://github.com/bitcoin/bitcoin/commit/39e3295c71)
* [2026-02-03 fuzz: move backend mutating block to end of coins_view](https://github.com/bitcoin/bitcoin/commit/86eda88c8e)
* [2026-02-02 refactor(miniscript): Move keys to avoid copy](https://github.com/bitcoin/bitcoin/commit/da51b5e4d2)
* [2026-01-31 fuzz: add target for CoinsViewOverlay](https://github.com/bitcoin/bitcoin/commit/cae6d895f8)
* [2026-01-26 test: Add CChain::FindFork() tests](https://github.com/bitcoin/bitcoin/commit/db56bcd692)
...
* [2026-01-20 test: Add CChain basic tests](https://github.com/bitcoin/bitcoin/commit/8333abdd91)
...
* [2025-11-18 tests: Add some test coverage for ArgsManager::AddCommand](https://github.com/bitcoin/bitcoin/commit/92df785859)
...
* [2025-07-04 index: add explicit early exit in NextSyncBlock() when the input is the chain tip](https://github.com/bitcoin/bitcoin/commit/db3c25cfae)
